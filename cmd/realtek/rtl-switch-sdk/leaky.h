 ...
 *      - LEAKY_LLDP.
 */
extern rtksw_api_ret_t rtksw_leaky_vlan_set(rtksw_uint32 unit, rtksw_leaky_type_t type, rtksw_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtksw_api_ret_t rtksw_leaky_vlan_get(rtksw_uint32 unit, rtksw_leaky_type_t type, rtksw_enable_t *pEnable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtksw_api_ret_t rtksw_leaky_portIsolation_set(rtksw_uint32 unit, rtksw_leaky_type_t type, rtksw_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtksw_api_ret_t rtksw_leaky_portIsolation_get(rtksw_uint32 unit, rtksw_leaky_type_t type, rtksw_enable_t *pEnable);

#if defined(CONFIG_COMPATIBLE_V1_4)

#define rtk_leaky_vlan_set(type, enable)                rtksw_leaky_vlan_set(0, type, enable)
#define rtk_leaky_vlan_get(type, pEnable)               rtksw_leaky_vlan_get(0, type, pEnable)
#define rtk_leaky_portIsolation_set(type, enable)       rtksw_leaky_portIsolation_set(0, type, enable)
#define rtk_leaky_portIsolation_get(type, pEnable)      rtksw_leaky_portIsolation_get(0, type, pEnable)

#define rtk_leaky_type_t        rtksw_leaky_type_t
