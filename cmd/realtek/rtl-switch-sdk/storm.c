 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlMeterIdx_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_uint32 index)
{
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlMeterIdx_set(unit, port, stormType, index);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlMeterIdx_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlMeterIdx_get(unit, port, stormType, pIndex);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlPortEnable_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlPortEnable_set(unit, port, stormType, enable);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlPortEnable_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlPortEnable_get(unit, port, stormType, pEnable);
    RTKSW_API_UNLOCK(unit);
 ...
 *      - BYPASS_LLDP.
 */
rtksw_api_ret_t rtksw_storm_bypass_set(rtksw_uint32 unit, rtksw_storm_bypass_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->storm_bypass_set(unit, type, enable);
    RTKSW_API_UNLOCK(unit);
 ...
 *      - BYPASS_LLDP.
 */
rtksw_api_ret_t rtksw_storm_bypass_get(rtksw_uint32 unit, rtksw_storm_bypass_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->storm_bypass_get(unit, type, pEnable);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtPortmask_set(rtksw_uint32 unit, rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlExtPortmask_set(unit, pPortmask);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtPortmask_get(rtksw_uint32 unit, rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlExtPortmask_get(unit, pPortmask);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtEnable_set(rtksw_uint32 unit, rtksw_rate_storm_group_t stormType, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlExtEnable_set(unit, stormType, enable);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtEnable_get(rtksw_uint32 unit, rtksw_rate_storm_group_t stormType, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlExtEnable_get(unit, stormType, pEnable);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtMeterIdx_set(rtksw_uint32 unit, rtksw_rate_storm_group_t stormType, rtksw_uint32 index)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlExtMeterIdx_set(unit, stormType, index);
    RTKSW_API_UNLOCK(unit);
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtMeterIdx_get(rtksw_uint32 unit, rtksw_rate_storm_group_t stormType, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
    ...
    RTKSW_API_LOCK(unit);
    retVal = RT_MAPPER->rate_stormControlExtMeterIdx_get(unit, stormType, pIndex);
    RTKSW_API_UNLOCK(unit);
