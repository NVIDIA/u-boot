 ...
 */
ret_t rtl8367c_setAsicRegBit(rtksw_uint32 unit, rtksw_uint32 reg, rtksw_uint32 bit, rtksw_uint32 value)
{
    ...
    retVal = reg_smi_write(unit, reg, regData);
    if(retVal != RT_ERR_OK)
        return RT_ERR_SMI;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRegBit(rtksw_uint32 unit, rtksw_uint32 reg, rtksw_uint32 bit, rtksw_uint32 *pValue)
{
 ...
 */
ret_t rtl8367c_setAsicRegBits(rtksw_uint32 unit, rtksw_uint32 reg, rtksw_uint32 bits, rtksw_uint32 value)
{

#if defined(RTK_X86_ASICDRV)
    printf("rtl8367c_setAsicRegBits RTK_X86_ASICDRV\n");
    rtksw_uint32 regData;
    ret_t retVal;
...
#elif defined(CONFIG_VIRTUAL_REG_ASICDRV_TEST)
    printf("rtl8367c_setAsicRegBits CONFIG_VIRTUAL_REG_ASICDRV_TEST\n");
    rtksw_uint32 regData;
    rtksw_uint32 bitsShift;
    rtksw_uint32 valueShifted;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRegBits(rtksw_uint32 unit, rtksw_uint32 reg, rtksw_uint32 bits, rtksw_uint32 *pValue)
{
 ...
 */
ret_t rtl8367c_setAsicReg(rtksw_uint32 unit, rtksw_uint32 reg, rtksw_uint32 value)
{
 ...
 */
ret_t rtl8367c_getAsicReg(rtksw_uint32 unit, rtksw_uint32 reg, rtksw_uint32 *pValue)
{
