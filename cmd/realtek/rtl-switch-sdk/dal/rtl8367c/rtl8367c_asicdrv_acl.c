...
/*
    Exchange structure type define with MMI and SMI
*/
static void _rtl8367c_aclRuleStUser2Smi(rtksw_uint32 unit, rtl8367c_aclrule *pAclUser, rtl8367c_aclrulesmi *pAclSmi)
{
    rtksw_uint8 *care_ptr, *data_ptr;
    rtksw_uint8 care_tmp, data_tmp;
    rtksw_uint32 i;
    switch_chip_t chipType = 0;
    ...
    /*the logic of acl entry id different between rtl8370C and rtl8370B series */
    chipType = rtksw_switch_chipType_get(unit);
    if (chipType == CHIP_RTL8370C ) //rtl8370C
    {
        for ( i = 0; i < sizeof(struct acl_rule_smi_st); i++)
        {
            care_tmp = ~(*(care_ptr + i)) | ~(*(data_ptr + i));
 ...
 *      None
 */
ret_t rtl8367c_setAsicAcl(rtksw_uint32 unit, rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(unit, RTL8367C_ACL_ENABLE_REG, port, enabled);
}
/* Function Name:
 *      rtl8367c_getAsicAcl
 * Description:
 ...
 *      None
 */
ret_t rtl8367c_getAsicAcl(rtksw_uint32 unit, rtksw_uint32 port, rtksw_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(unit, RTL8367C_ACL_ENABLE_REG, port, pEnabled);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclUnmatchedPermit(rtksw_uint32 unit, rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(unit, RTL8367C_ACL_UNMATCH_PERMIT_REG, port, enabled);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclUnmatchedPermit(rtksw_uint32 unit, rtksw_uint32 port, rtksw_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(unit, RTL8367C_ACL_UNMATCH_PERMIT_REG, port, pEnabled);
}
 ...
 */
ret_t rtl8367c_setAsicAclRule(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_aclrule* pAclRule)
{
    ...
    osal_memset(&aclRuleSmi, 0x00, sizeof(rtl8367c_aclrulesmi));

    _rtl8367c_aclRuleStUser2Smi(unit, pAclRule, &aclRuleSmi);
    ...
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), 0x1, 0);
    if(retVal !=RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), (0x0007 << 1), (aclRuleSmi.care_bits_ext.rule_info >> 1) & 0x0007);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_setAsicRegBit(unit, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), 0, aclRuleSmi.valid);
    if(retVal != RT_ERR_OK)
        return retVal;
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), (0x0007 << 1), (aclRuleSmi.data_bits_ext.rule_info >> 1) & 0x0007);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    osal_memcpy(&Rtl8370sVirtualAclRuleTable[index], &aclRuleSmi, sizeof(rtl8367c_aclrulesmi));
#endif
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclRule(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_aclrule *pAclRule)
{
    rtl8367c_aclrulesmi aclRuleSmi;
    ...
    /* Read Valid Bit */
    retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_TABLE_ACCESS_RDDATA_REG(RTL8367C_ACLRULETBLEN), 0, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    aclRuleSmi.valid = regData & 0x1;
    /* Read active_portmsk_ext Bits */
    retVal = rtl8367c_getAsicRegBits(unit, RTL8367C_TABLE_ACCESS_RDDATA_REG(RTL8367C_ACLRULETBLEN), 0x7<<1, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;    
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    osal_memcpy(&aclRuleSmi,&Rtl8370sVirtualAclRuleTable[index], sizeof(rtl8367c_aclrulesmi));
#endif
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclNot(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 not)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;

    if(index < 64)
        return rtl8367c_setAsicRegBit(unit, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), not);
    else
        return rtl8367c_setAsicRegBit(unit, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), not);
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclNot(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32* pNot)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;

    if(index < 64)
        return rtl8367c_getAsicRegBit(unit, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), pNot);
    else
        return rtl8367c_getAsicRegBit(unit, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), pNot);
 ...
 */
ret_t rtl8367c_setAsicAclTemplate(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_acltemplate_t* pAclType)
{
    ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 regAddr, regData;
    ...
    for(i = 0; i < (RTL8367C_ACLRULEFIELDNO/2); i++)
    {
        ...
        retVal = rtl8367c_setAsicReg(unit, regAddr + i, regData);
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclTemplate(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_acltemplate_t *pAclType)
{
    ret_t retVal;
    rtksw_uint32 i;
    ...
    for(i = 0; i < (RTL8367C_ACLRULEFIELDNO/2); i++)
    {
        retVal = rtl8367c_getAsicReg(unit, regAddr + i,&regData);
        if(retVal != RT_ERR_OK)
            return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclAct(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_acl_act_t* pAclAct)
{
    ...
    osal_memset(aclActSmi, 0x00, sizeof(rtksw_uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    osal_memcpy(&Rtl8370sVirtualAclActTable[index][0], aclActSmi, sizeof(rtksw_uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
#endif
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclAct(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_acl_act_t *pAclAct)
{
    rtksw_uint16 aclActSmi[RTL8367C_ACL_ACT_TABLE_LEN];
    ret_t retVal;
    rtksw_uint32 regAddr, regData;
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    osal_memcpy(aclActSmi, &Rtl8370sVirtualAclActTable[index][0], sizeof(rtksw_uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
#endif
 ...
 */
ret_t rtl8367c_setAsicAclActCtrl(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 aclActCtrl)
{
    ret_t retVal;
    ...
    if(index >= 64)
        retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), aclActCtrl);
    else
        retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), aclActCtrl);
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclActCtrl(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 *pAclActCtrl)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ...
    if(index >= 64)
        retVal = rtl8367c_getAsicRegBits(unit, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), &regData);
    else
        retVal = rtl8367c_getAsicRegBits(unit, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), &regData);
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclPortRange(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 type, rtksw_uint32 upperPort, rtksw_uint32 lowerPort)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL2 + index*3, RTL8367C_ACL_SDPORT_RANGE_ENTRY0_CTRL2_MASK, type);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL1 + index*3, upperPort);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL0 + index*3, lowerPort);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclPortRange(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32* pType, rtksw_uint32* pUpperPort, rtksw_uint32* pLowerPort)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_getAsicRegBits(unit, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL2 + index*3, RTL8367C_ACL_SDPORT_RANGE_ENTRY0_CTRL2_MASK, pType);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL1 + index*3, pUpperPort);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL0 + index*3, pLowerPort);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclVidRange(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 type, rtksw_uint32 upperVid, rtksw_uint32 lowerVid)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ...
    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL1 + index*2, regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL0 + index*2, lowerVid);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclVidRange(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32* pType, rtksw_uint32* pUpperVid, rtksw_uint32* pLowerVid)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ...
    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL1 + index*2, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    *pUpperVid = regData & RTL8367C_ACL_VID_RANGE_ENTRY0_CTRL1_CHECK0_HIGH_MASK;
    ...
    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL0 + index*2, pLowerVid);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclIpRange(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 type, ipaddr_t upperIp, ipaddr_t lowerIp)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ipaddr_t ipData;
    ...
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL4 + index*5, RTL8367C_ACL_IP_RANGE_ENTRY0_CTRL4_MASK, type);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL2 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    regData = (ipData>>16) & 0xFFFF;
    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL3 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    regData = ipData & 0xFFFF;
    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL0 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    regData = (ipData>>16) & 0xFFFF;
    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL1 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclIpRange(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32* pType, ipaddr_t* pUpperIp, ipaddr_t* pLowerIp)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ipaddr_t ipData;
    ...
    retVal = rtl8367c_getAsicRegBits(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL4 + index*5, RTL8367C_ACL_IP_RANGE_ENTRY0_CTRL4_MASK, pType);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL2 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ipData = regData;


    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL3 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    *pUpperIp = ipData;
    ...
    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL0 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ipData = regData;


    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL1 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      none
 */
ret_t rtl8367c_setAsicAclGpioPolarity(rtksw_uint32 unit, rtksw_uint32 polarity)
{
    return rtl8367c_setAsicRegBit(unit, RTL8367C_REG_ACL_GPIO_POLARITY, RTL8367C_ACL_GPIO_POLARITY_OFFSET, polarity);
}
 ...
 *      none
 */
ret_t rtl8367c_getAsicAclGpioPolarity(rtksw_uint32 unit, rtksw_uint32* pPolarity)
{
    return rtl8367c_getAsicRegBit(unit, RTL8367C_REG_ACL_GPIO_POLARITY, RTL8367C_ACL_GPIO_POLARITY_OFFSET, pPolarity);
}
