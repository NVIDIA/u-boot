 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_enable_set(rtksw_uint32 unit, rtksw_led_group_t group, rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_enable_get(rtksw_uint32 unit, rtksw_led_group_t group, rtksw_portmask_t *pPortmask);
 ...
 *      - LED_OP_SERIAL,
 */
extern rtksw_api_ret_t dal_rtl8367c_led_operation_set(rtksw_uint32 unit, rtksw_led_operation_t mode);
 ...
 *      - LED_OP_SERIAL,
 */
extern rtksw_api_ret_t dal_rtl8367c_led_operation_get(rtksw_uint32 unit, rtksw_led_operation_t *pMode);
 ...
 *      - LED_FORCE_ON.
 */
extern rtksw_api_ret_t dal_rtl8367c_led_modeForce_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_led_group_t group, rtksw_led_force_mode_t mode);
 ...
 *      - LED_FORCE_ON.
 */
extern rtksw_api_ret_t dal_rtl8367c_led_modeForce_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_led_group_t group, rtksw_led_force_mode_t *pMode);
 ...
 *      - LED_BLINKRATE_96MS,
 */
extern rtksw_api_ret_t dal_rtl8367c_led_blinkRate_set(rtksw_uint32 unit, rtksw_led_blink_rate_t blinkRate);
 ...
 *      - LED_BLINKRATE_96MS,
 */
extern rtksw_api_ret_t dal_rtl8367c_led_blinkRate_get(rtksw_uint32 unit, rtksw_led_blink_rate_t *pBlinkRate);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_groupConfig_set(rtksw_uint32 unit, rtksw_led_group_t group, rtksw_led_config_t config);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_groupConfig_get(rtksw_uint32 unit, rtksw_led_group_t group, rtksw_led_config_t *pConfig);
...
extern rtksw_api_ret_t dal_rtl8367c_led_groupAbility_set(rtksw_uint32 unit, rtksw_led_group_t group, rtksw_led_ability_t *pAbility);
...
extern rtksw_api_ret_t dal_rtl8367c_led_groupAbility_get(rtksw_uint32 unit, rtksw_led_group_t group, rtksw_led_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_serialMode_set(rtksw_uint32 unit, rtksw_led_active_t active);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_serialMode_get(rtksw_uint32 unit, rtksw_led_active_t *pActive);
 ...
 *      This API set LED I/O state.
 */
extern rtksw_api_ret_t dal_rtl8367c_led_OutputEnable_set(rtksw_uint32 unit, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_led_OutputEnable_get(rtksw_uint32 unit, rtksw_enable_t *pState);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_led_serialModePortmask_set(rtksw_uint32 unit, rtksw_led_serialOutput_t output, rtksw_portmask_t *pPortmask);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_led_serialModePortmask_get(rtksw_uint32 unit, rtksw_led_serialOutput_t *pOutput, rtksw_portmask_t *pPortmask);
