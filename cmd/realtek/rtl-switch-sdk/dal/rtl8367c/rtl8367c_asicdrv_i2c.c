 ...
 */
ret_t rtl8367c_setAsicI2C_checkBusIdle(rtksw_uint32 unit)
{
    rtksw_uint32 regData;
    ret_t retVal;

    if ((retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_REG_M_I2C_CTL_STA_REG, RTL8367C_M_I2C_BUS_IDLE_OFFSET, &regData)) != RT_ERR_OK)
        return retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CStartCmd(rtksw_uint32 unit)
{
    rtksw_uint32 regData;
    ret_t retVal;

    /* Bits [4-1] = 0b0000, Start Command; Bit [0] = 1, Trigger the Command */
    if ((retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_M_I2C_CTL_STA_REG, &regData)) != RT_ERR_OK)
        return retVal;
    regData &= 0xFFE0;
    regData |= 0x0001;

    if ((retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_M_I2C_CTL_STA_REG, regData)) != RT_ERR_OK)
        return retVal;

    /* wait for command finished */
    do{
       if ((retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_REG_M_I2C_CTL_STA_REG, RTL8367C_I2C_CMD_EXEC_OFFSET, &regData)) != RT_ERR_OK)
            return retVal;
    }while( regData != 0x0);
 ...
 */
ret_t rtl8367c_setAsicI2CStopCmd(rtksw_uint32 unit)
{
 ...
 */
ret_t rtl8367c_setAsicI2CTxOneCharCmd(rtksw_uint32 unit, rtksw_uint8 oneChar)
{
    rtksw_uint32 regData;
    ret_t retVal;
    ...
    regData |= 0x0005;
    regData &= 0x00FF;
    regData |= (rtksw_uint16) (oneChar << 8);
 ...
 */
ret_t rtl8367c_setAsicI2CcheckRxAck(rtksw_uint32 unit)
{
    rtksw_uint32 regData;
    ret_t retVal;
    rtksw_uint32 count = 0;

    do{
         count++;
         if ((retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_REG_M_I2C_CTL_STA_REG, RTL8367C_SLV_ACK_FLAG_OFFSET, &regData)) != RT_ERR_OK)
            return retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CRxOneCharCmd(rtksw_uint32 unit, rtksw_uint8 *pValue)
{
    rtksw_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CTxAckCmd(rtksw_uint32 unit)
{
    rtksw_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CTxNoAckCmd(rtksw_uint32 unit)
{
    rtksw_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CSoftRSTseqCmd(rtksw_uint32 unit)
{
 ...
 */
ret_t rtl8367c_setAsicI2CGpioPinGroup(rtksw_uint32 unit, rtksw_uint32 pinGroup_ID)
{
    rtksw_uint32 regData;
    ret_t retVal;

    if ((retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_M_I2C_SYS_CTL, &regData)) != RT_ERR_OK)
         return retVal;
    if( pinGroup_ID==0 )
    {
        regData &= 0x0FFF;
        ...
        if ((retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_M_I2C_SYS_CTL, regData)) != RT_ERR_OK)
             return retVal;
    }
 ...
 *      There are three group gpio pins
 */
ret_t rtl8367c_getAsicI2CGpioPinGroup(rtksw_uint32 unit, rtksw_uint32 *pPinGroup_ID)
{
