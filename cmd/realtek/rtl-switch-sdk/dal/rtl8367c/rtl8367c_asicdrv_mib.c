 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsCounterReset(rtksw_uint32 unit, rtksw_uint32 greset, rtksw_uint32 qmreset, rtksw_uint32 portmask)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_REG_MIB_CTRL0, regBits, (regData >> RTL8367C_PORT0_RESET_OFFSET));
 ...
 */
ret_t rtl8367c_getAsicMIBsCounter(rtksw_uint32 unit, rtksw_uint32 port, RTL8367C_MIBCOUNTER mibIdx, rtksw_uint64* pCounter)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_MIB_ADDRESS, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    if (regData == (mibAddr >> 2))
    {
        ...
        retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_MIB_ADDRESS, (mibAddr >> 2) + 1);
        if(retVal != RT_ERR_OK)
            return retVal;
        ...
        while(i > 0)
        {
            ...
            retVal = rtl8367c_getAsicReg(unit, RTL8367C_MIB_CTRL_REG,&regData);
            if(retVal != RT_ERR_OK)
                return retVal;
    ...
    retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_MIB_ADDRESS, (mibAddr >> 2));
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 */
ret_t rtl8367c_getAsicMIBsLogCounter(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 *pCounter)
{
    ret_t retVal;
    rtksw_uint32 regAddr;
    rtksw_uint32 regData;
 ...
 */
ret_t rtl8367c_getAsicMIBsControl(rtksw_uint32 unit, rtksw_uint32* pMask)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetValue(rtksw_uint32 unit, rtksw_uint32 value)
{
    return rtl8367c_setAsicRegBit(unit, RTL8367C_REG_MIB_CTRL0, RTL8367C_RESET_VALUE_OFFSET, value);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsResetValue(rtksw_uint32 unit, rtksw_uint32* value)
{
    return rtl8367c_getAsicRegBit(unit, RTL8367C_REG_MIB_CTRL0, RTL8367C_RESET_VALUE_OFFSET, value);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsUsageMode(rtksw_uint32 unit, rtksw_uint32 mode)
{
    return rtl8367c_setAsicRegBit(unit, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_USAGE_MODE_OFFSET, mode);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsUsageMode(rtksw_uint32 unit, rtksw_uint32* pMode)
{
    return rtl8367c_getAsicRegBit(unit, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_USAGE_MODE_OFFSET, pMode);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsTimer(rtksw_uint32 unit, rtksw_uint32 timer)
{
    return rtl8367c_setAsicRegBits(unit, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_TIMER_MASK, timer);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsTimer(rtksw_uint32 unit, rtksw_uint32* pTimer)
{
    return rtl8367c_getAsicRegBits(unit, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_TIMER_MASK, pTimer);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingMode(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 mode)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_setAsicRegBit(unit, RTL8367C_REG_MIB_CTRL3, index,mode);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingMode(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32* pMode)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_getAsicRegBit(unit, RTL8367C_REG_MIB_CTRL3, index,pMode);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingType(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32 type)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_setAsicRegBit(unit, RTL8367C_REG_MIB_CTRL5, index,type);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingType(rtksw_uint32 unit, rtksw_uint32 index, rtksw_uint32* pType)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_getAsicRegBit(unit, RTL8367C_REG_MIB_CTRL5, index,pType);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetLoggingCounter(rtksw_uint32 unit, rtksw_uint32 index)
{
    ret_t retVal;
    ...
    if(index < 16)
        retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_MIB_CTRL1, 1<<index);
    else
        retVal = rtl8367c_setAsicReg(unit, RTL8367C_REG_MIB_CTRL2, 1<<(index-16));
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLength(rtksw_uint32 unit, rtksw_uint32 txLengthMode, rtksw_uint32 rxLengthMode)
{
    ret_t retVal;

    if( (retVal = rtl8367c_setAsicRegBit(unit, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_TX_LENGTH_CTRL_OFFSET, txLengthMode)) != RT_ERR_OK)
        return retVal;

    if( (retVal = rtl8367c_setAsicRegBit(unit, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_RX_LENGTH_CTRL_OFFSET, rxLengthMode)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLength(rtksw_uint32 unit, rtksw_uint32 *pTxLengthMode, rtksw_uint32 *pRxLengthMode)
{
    ret_t retVal;

    if( (retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_TX_LENGTH_CTRL_OFFSET, pTxLengthMode)) != RT_ERR_OK)
        return retVal;

    if( (retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_RX_LENGTH_CTRL_OFFSET, pRxLengthMode)) != RT_ERR_OK)
        return retVal;
