 ...
 *      None
 */
ret_t rtl8367c_setAsicRma(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_rma_t* pRmacfg)
{
    ...
    retVal = rtl8367c_setAsicRegBits(unit, RTL8367C_REG_RMA_CTRL00, RTL8367C_TRAP_PRIORITY_MASK, pRmacfg->trap_priority);
    if(retVal != RT_ERR_OK)
        return retVal;

    return rtl8367c_setAsicReg(unit, RTL8367C_REG_RMA_CTRL00+index, regData);
}
/* Function Name:
 *      rtl8367c_getAsicRma
 * Description:
 ...
 *      None
 */
ret_t rtl8367c_getAsicRma(rtksw_uint32 unit, rtksw_uint32 index, rtl8367c_rma_t* pRmacfg)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_RMA_CTRL00+index, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_getAsicRegBits(unit, RTL8367C_REG_RMA_CTRL00, RTL8367C_TRAP_PRIORITY_MASK, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRmaCdp(rtksw_uint32 unit, rtl8367c_rma_t* pRmacfg)
{
    rtksw_uint32 regData = 0;
    ret_t retVal;
    ...
    return rtl8367c_setAsicReg(unit, RTL8367C_REG_RMA_CTRL_CDP, regData);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicRmaCdp(rtksw_uint32 unit, rtl8367c_rma_t* pRmacfg)
{
    ret_t retVal;
    rtksw_uint32 regData;

    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_RMA_CTRL_CDP, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRmaCsstp(rtksw_uint32 unit, rtl8367c_rma_t* pRmacfg)
{
    rtksw_uint32 regData = 0;
    ret_t retVal;
    ...
    return rtl8367c_setAsicReg(unit, RTL8367C_REG_RMA_CTRL_CSSTP, regData);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicRmaCsstp(rtksw_uint32 unit, rtl8367c_rma_t* pRmacfg)
{
    ret_t retVal;
    rtksw_uint32 regData;

    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_RMA_CTRL_CSSTP, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRmaLldp(rtksw_uint32 unit, rtksw_uint32 enabled, rtl8367c_rma_t* pRmacfg)
{
    rtksw_uint32 regData = 0;
    ret_t retVal;
    ...
    retVal = rtl8367c_setAsicRegBit(unit, RTL8367C_REG_RMA_LLDP_EN, RTL8367C_RMA_LLDP_EN_OFFSET,enabled);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    return rtl8367c_setAsicReg(unit, RTL8367C_REG_RMA_CTRL_LLDP, regData);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicRmaLldp(rtksw_uint32 unit, rtksw_uint32 *pEnabled, rtl8367c_rma_t* pRmacfg)
{
    ret_t retVal;
    rtksw_uint32 regData;

    retVal = rtl8367c_getAsicRegBit(unit, RTL8367C_REG_RMA_LLDP_EN, RTL8367C_RMA_LLDP_EN_OFFSET,pEnabled);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(unit, RTL8367C_REG_RMA_CTRL_LLDP, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
