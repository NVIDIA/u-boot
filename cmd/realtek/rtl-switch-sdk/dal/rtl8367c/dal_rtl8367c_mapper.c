...
static dal_mapper_t dal_rtl8367c_mapper =
{
    ...
    .switch_reset = dal_rtl8367c_switch_reset,
    ...
    .led_parallelLEDRemap_set = NULL,
    .led_parallelLEDRemap_get = NULL,
    .led_parallelLEDState_set = NULL,
    .led_parallelLEDState_get = NULL,
    ...
    /*WoL*/
    .wol_init = dal_rtl8367c_wol_init,
    .wol_state_set = dal_rtl8367c_wol_state_set,
    .wol_systemMac_set = dal_rtl8367c_wol_systemMac_set,
