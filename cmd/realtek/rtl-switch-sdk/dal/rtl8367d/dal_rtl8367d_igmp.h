 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_igmp_protocol_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_igmp_protocol_t protocol, rtksw_igmp_action_t action);
 ...
 *      This API set IGMP/MLD protocol action
 */
extern rtksw_api_ret_t dal_rtl8367d_igmp_protocol_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_igmp_protocol_t protocol, rtksw_igmp_action_t *pAction);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_igmp_bypassGroupRange_set(rtksw_uint32 unit, rtksw_igmp_bypassGroup_t group, rtksw_enable_t enabled);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_igmp_bypassGroupRange_get(rtksw_uint32 unit, rtksw_igmp_bypassGroup_t group, rtksw_enable_t *pEnable);
