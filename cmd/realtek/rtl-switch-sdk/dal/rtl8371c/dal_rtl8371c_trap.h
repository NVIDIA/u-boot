...
#ifndef __DAL_RTL8371C_TRAP_H__
#define __DAL_RTL8371C_TRAP_H__

#include "../../trap.h"

enum RTL8371C_L2_UNKOWN_MULTICAST_BEHAVE
{
    RTL8371C_L2_UNKOWN_MULTICAST_FLOODING = 0,
    RTL8371C_L2_UNKOWN_MULTICAST_DROP,
    RTL8371C_L2_UNKOWN_MULTICAST_TRAP,
    RTL8371C_L2_UNKOWN_MULTICAST_DROP_EXCLUDE_RMA,
    RTL8371C_L2_UNKOWN_MULTICAST_END
};

#define RTL8371C_TRAP_PRIMAX    7
 ...
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_unknownUnicastPktAction_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action);
 ...
 *          - UCAST_ACTION_FLOODING
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_unknownUnicastPktAction_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action);
 ...
 * Note:
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_unmatchMacMoving_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_enable_t enable);
 ...
 * Note:
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_unmatchMacMoving_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_unknownMcastPktAction_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_mcast_type_t type, rtksw_trap_mcast_action_t mcast_action);
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_unknownMcastPktAction_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_mcast_type_t type, rtksw_trap_mcast_action_t *pMcast_action);
 ...
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_lldpEnable_set(rtksw_uint32 unit, rtksw_enable_t enabled);
 ...
 *      - 01:80:c2:00:00:00 ethertype = 0x88CC
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_lldpEnable_get(rtksw_uint32 unit, rtksw_enable_t *pEnabled);
 ...
 *      - TRAP_REASON_IGMPMLD
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_reasonTrapToCpuPriority_set(rtksw_uint32 unit, rtksw_trap_reason_type_t type, rtksw_pri_t priority);
 ...
 *      - TRAP_REASON_IGMPMLD
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_reasonTrapToCpuPriority_get(rtksw_uint32 unit, rtksw_trap_reason_type_t type, rtksw_pri_t *pPriority);
 ...
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_rmaAction_set(rtksw_uint32 unit, rtksw_trap_type_t type, rtksw_trap_rma_action_t rma_action);
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_rmaAction_get(rtksw_uint32 unit, rtksw_trap_type_t type, rtksw_trap_rma_action_t *pRma_action);
 ...
 *      - TRAP_LLDP.
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_rmaKeepFormat_set(rtksw_uint32 unit, rtksw_trap_type_t type, rtksw_enable_t enable);
 ...
 *      - TRAP_LLDP.
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_rmaKeepFormat_get(rtksw_uint32 unit, rtksw_trap_type_t type, rtksw_enable_t *pEnable);
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_portUnknownMacPktAction_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_portUnknownMacPktAction_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action);
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_portUnmatchMacPktAction_set(rtksw_uint32 unit, rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action);
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtksw_api_ret_t dal_rtl8371c_trap_portUnmatchMacPktAction_get(rtksw_uint32 unit, rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action);

#endif /* __DAL_RTL8371C_TRAP_H__ */
